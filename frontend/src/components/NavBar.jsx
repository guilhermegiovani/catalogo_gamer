...
function NavBar() {
    ...
    return (
        <nav className={clsx(
            ...
            "bg-transparent text-whit mb-6 lg:mb-10 px-4 md:px-10"
        )}>
            ...
            <Button
                ...
                className="lg:hidden p-2 cursor-pointer hover:scale(1.04)"
                handleClick={() => setMenuOpen(prev => !prev)}
            />


            <div className="hidden lg:flex items-center gap-6 text-md lg:text-lg landscape:xl:text-xl font-normal ml-100">
                ...
                {user ? (
                    ...
                    <div ref={dropdownref} className="relative">
                        <img
                            ...
                            alt="avatar"
                            className="rounded-full shadow-sm w-15 h-15 cursor-pointer"
            ...
            {menuOpen && (
                <div className={clsx(
                    "absolute top-16 right-5 w-auto bg-white/5 border-t border-[#2d2d5f]",
